...
export default function Header(props) {
	...
	const [zipcode, setZipcode] = useState(
		props.user === undefined ? 98109 : props.user.zipcode
	);
	...
	return (
		<div className="storefront-header">
			<div className="upper">
				...
				>
					<img alt="header-logo" src={logo} width="80px" />
				</div>
				...
				<div className="menu">
					...
					>
						...
						<Dropdown.Menu className="dropdown">
							{menuContent1.map((contentBlock, idx) => (
								<div className="dropdown-block" key={idx}>
				...
				<div className="cart">
					<label>
						<img alt="cart-icon" src={cartIcon} width="30px" />
						Cart
					</label>
				</div>
			</div>
